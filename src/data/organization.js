export const OTableConfig = {
  ...
  lazy: true,
  columns: [
    { label: '名称', field: 'aqglRiskTissueName', width: '200', layout: 'Text', require: true, placeholder: '请填写名称' },
    { label: '编号', field: 'aqglRiskTissueId', width: '150', layout: 'Text', immutable: true, placeholder: '请填写编号' },
    { label: '创建日期', field: 'createTime', width: '200', sortable: true, layout: 'DateTime', immutable: true, placeholder: '请选择日期' },
    { label: '排序', field: 'orderNum', width: '150', layout: 'Text', require: true, placeholder: '请选择排序' },
...
export const HiddenTissueConfig = {
  ...
  lazy: true,
  columns: [
    { label: '隐患组织id', field: 'aqglHiddenTissueId', width: '150', layout: 'Text', immutable: true, placeholder: '请填写隐患组织id', hidden: true },
    { label: '单位', field: 'company', width: '200', layout: 'Text', require: true, placeholder: '请填写名称' },
    { label: '编号', field: 'code', width: '150', layout: 'Text', immutable: true, placeholder: '请填写编号' },
