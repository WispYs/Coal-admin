<template>
  <div class="page-container">
    <app-power-filter-bar :updateDisabled="updateDisabled" :deleteDisabled="deleteDisabled"
      @openDialog="openDialog" @deleteClick="deleteClick" @synchroClick="synchroClick" @queryData="queryData"></app-power-filter-bar>

    <list-table :id="id" :list="list" :list-loading="listLoading" :config="AppPowerConfig" @selectionChange="selectionChange"
