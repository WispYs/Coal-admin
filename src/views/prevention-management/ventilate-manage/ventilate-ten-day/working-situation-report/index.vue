<template>
  <div class="page-container report-table">
    ...
    <h2 style="text-align: center;margin: 20px 0;font-weight: normal;">矿井（中央区）采煤工作面通风情况</h2>
    <el-table
      :id="id"
    ...
    >
      ...
      <el-table-column align="center" label="进风" width="300">
        <el-table-column
      ...
      <el-table-column align="center" label="回风" width="300">
        <el-table-column
          v-for="(column,index) in config.columns2"
          :key="index"
          :label="column.label"
      ...
      <el-table-column align="center" label="工作面" width="120">
        <el-table-column
          v-for="(column,index) in config.columns3"
          :key="index"
          :label="column.label"
          :width="column.width"
          :align="column.align || 'center'"
      ...
      <el-table-column align="center" label="上隅角" width="120">
        <el-table-column
          v-for="(column,index) in config.columns4"
          :key="index"
          :label="column.label"
          :width="column.width"
          :align="column.align || 'center'"
...
export default {
  data() {
    return {
      ...
      config: {
        columns: [
          { label: '主要工作面名称', field: 'name', layout: 'Text', placeholder: '请填写名称' }
        ],
        columns2: [
          { label: 's(m²)', field: 's', layout: 'Text', placeholder: '请填写数值' },
          { label: 'v(m/s)', field: 'v', layout: 'Text', placeholder: '请填写数值' },
          { label: 'q(m³/min)', field: 'q', layout: 'Text', placeholder: '请填写数值' },
