<template>
  <div class="page-container report-table">
    ...
    <h2 style="text-align: center;margin: 20px 0;font-weight: normal;">矿井（中央区）掘进面旬报表</h2>
    <el-table
      :id="id"
    ...
    >
      ...
      <el-table-column align="center" label="工作面" width="120">
        <el-table-column
          v-for="(column,index) in config.columns2"
          :key="index"
          :label="column.label"
          :width="column.width"
          :align="column.align || 'center'"
      ...
      <el-table-column align="center" label="回风" width="120">
        <el-table-column
          v-for="(column,index) in config.columns2"
          :key="index"
          :label="column.label"
...
export default {
  data() {
    return {
      ...
      config: {
        columns: [
          { label: '主要掘进面名称', field: 'name', layout: 'Text', placeholder: '请填写名称' },
          { label: '局扇功率(kw)', field: 'power', layout: 'Text', placeholder: '请填写功率' },
          { label: '局扇运行状况', field: 'status', layout: 'Text', placeholder: '请填写状况' },
          { label: '风筒直径(mm)', field: 'diameter', layout: 'Text', placeholder: '请填写风筒直径' },
          { label: '供风距离(m)', field: 'distance', layout: 'Text', placeholder: '请填写供风距离' },
          { label: '局扇所在巷道风量(m³/min)', field: 'rate', layout: 'Text', placeholder: '请填写风量' },
          { label: '巷道断面积(m²)', field: 'area', layout: 'Text', placeholder: '请填写断面积' },
          { label: '巷道风速(m/s)', field: 'speed', layout: 'Text', placeholder: '请填写巷道风速' },
          { label: '迎风风筒出口风量(m³/min)', field: 'flow1', layout: 'Text', placeholder: '请填写出口风量' },
          { label: '掘进巷道回风风量(m²)', field: 'flow2', layout: 'Text', placeholder: '请填写回风风量' }
        ],
        columns2: [
          { label: 'CH²(%)', field: 'ch', layout: 'Text', placeholder: '请填写数值' },
          { label: 'CO²(%)', field: 'co', layout: 'Text', placeholder: '请填写数值' },
          { label: 't(℃)', field: 't', layout: 'Text', placeholder: '请填写数值' }
        ]
      },
        ...
        this.list = [
          {
            ...
            co: 0,
            t: 0,
            editable: ['name', 'power', 'status', 'diameter', 'distance', 'rate', 'area', 'speed', 'flow1', 'flow2', 'ch', 'co', 't']
          }
        ]
      })
    },
