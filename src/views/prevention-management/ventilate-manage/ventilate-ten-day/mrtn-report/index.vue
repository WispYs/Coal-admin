<template>
  <div class="page-container report-table">
    ...
    <h2 style="text-align: center;margin: 20px 0;font-weight: normal;">矿井（中央区）回风量旬报表</h2>
    <el-table
      :id="id"
    ...
    >
      ...
      <el-table-column align="center" label="本旬矿井回风气体情况" width="200">
        <el-table-column
...
export default {
  data() {
    return {
      ...
      config: {
        columns: [
          { label: '区域', field: 'region', layout: 'Text', placeholder: '请填写区域' },
          { label: '地点', field: 'addr', layout: 'Text', placeholder: '请填写地点' },
          { label: '断面(m²)', field: 'area', layout: 'Text', placeholder: '请填写断面' },
          { label: '风速(m/s)', field: 'speed', layout: 'Text', placeholder: '请填写风速' },
          { label: '风量(m³/min)', field: 'rate', layout: 'Text', placeholder: '请填写风量' }
        ],
        columns2: [
        ...
        this.list = [
          {
            ...
            co: 0,
            t: 0,
            editable: ['region', 'addr', 'area', 'speed', 'rate', 'ch', 'co', 't']
          }
        ]
      })
    },
