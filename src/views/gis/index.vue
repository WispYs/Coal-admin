  ...
  <div style="width:100%;height:100%">
    ...
    <div class="side-wrapper">
      <div class="left-side-wrapper">
        <el-button @click="openDrawer('jsDrawer', $event)" class="side-item"
          >检索</el-button
        >
        <el-button class="side-item" @click="openDrawer('zhDrawer', $event)"
          >综合</el-button
        >
          ...
          <div class="drawer-wrapper">
            ...
            >
              <el-select
                ...
                placeholder="全部"
              >
                <el-option label="井巷项目" value="1"></el-option>
                <el-option label="订单号" value="2"></el-option>
                <el-option label="矿金深度" value="3"></el-option>
              </el-select>
          ...
          <el-tabs v-model="activeName">
            ...
            <el-tab-pane label="安全状况" name="second">
              ...
              <div class="list-item-wrapper">
                <div class="list-item" v-for="idx in 4" :key="idx">
                  <img
                    class="js-tools-img"
                    src="//www.baidu.com/img/flexible/logo/pc/result@2.png"
                    alt=""
      ...
      <div class="right-side-wrapper">
        <el-checkbox-group class="paper-wrapper" v-model="selecedtPaper">
          <el-checkbox-button
    ...
    <div id="gis-wrapper" class="gis-wrapper"></div>
...
export default {
  ...
  mounted() {
    ...
    api.Events.finishRender.on("default", function(e) {
      //获取视点列表
      let viewpointlist = model.BIM365API.Data.getMainModel().activeView.getViewpointList();
      //viewpoint 视点 annotation批注数据
      console.log(viewpointlist);
      //for(var i=0;i<viewpointlist.annotation.length;i++)
      var i = 1;
      {
        let annotation = viewpointlist.annotation[i];
        let inf = JSON.parse(annotation.override);
        //console.log(inf)
        //console.log(annotation)

        //添加锚点
        let pos = inf.controlPostion;
        pos.y = 0;
        var a = 1;
  ...
  methods: {
    ...
    fullScreen() {
      const idx = this.topConfig.findIndex(t => t.name == "全屏"),
        flag = (this.topConfig[idx]["status"] = !this.topConfig[idx]["status"]),
        el = flag ? document.documentElement : document,
        rfs = flag
    ...
    randPoint(ctl, controlPostion) {
      for (var i = 1; i < 21; i++) {
        ...
        let pos = JSON.parse(JSON.stringify(controlPostion));
        ...
        let data = model.BIM365API.Extension.Point.addAnchorPointByPosition(
          pos,
          "http://www.probim.cn:8088/bimexample/img/point.png",
          dt
        );
