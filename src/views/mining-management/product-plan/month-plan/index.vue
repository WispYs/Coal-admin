<template>
  <div class="page-container report-table">
    ...
    >
      ...
      <el-table-column prop="sskq" label="所属矿区"> </el-table-column>
      <el-table-column label="巷道情况">
        <el-table-column prop="dwgcmc" label="单位工程名称"> </el-table-column>
        ...
        <el-table-column prop="sjgcl" label="设计工程量"> </el-table-column>
        <el-table-column prop="sygcl" label="剩余工程量"> </el-table-column>
        <el-table-column prop="mylb" label="煤岩类别"> </el-table-column>
        <el-table-column prop="dm" label="断面(m²)"> </el-table-column>
        <el-table-column prop="jjfs" label="掘进方式"> </el-table-column>
      ...
      <el-table-column label="本月计划(m)">
        <el-table-column prop="gcl" label="工程量"> </el-table-column>
