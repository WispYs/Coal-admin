<template>
  <div class="page-container">
    ...
    <filter-bar
      :config="EmergencyResponseFilterConfig"
    ...
    <list-table
      ...
      :config="EmergencyResponseTeamTableConfig"
...
export default {
  ...
  methods: {
    ...
    //     // 更新新增、编辑config数据
    //     EmergencyResponseTeamTableConfig.columns.forEach(it => {
    ...
    initCreateConfig() {
      const createConfig = Object.assign({
        title: '新建',
        width: '1000px',
        form: this.EmergencyResponseTeamTableConfig.columns
      })
      return createConfig
    },
    // 初始化编辑窗口配置
