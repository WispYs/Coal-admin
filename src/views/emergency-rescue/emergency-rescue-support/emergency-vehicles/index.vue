<template>
  <div class="page-container">
    ...
    <filter-bar
      :config="EmergencyVehiclesFilterConfig"
    ...
    <list-table
      ...
      :config="EmergencyVehiclesTableConfig"
...
export default {
  ...
  methods: {
    ...
    __fetchData() {
      ...
      const filter = {
        ...this.filter,
        keywordField: ['vehicleName', 'modelNumber']
      }
    ...
    initCreateConfig() {
      const createConfig = Object.assign({
        title: '新建',
        width: '1000px',
        form: this.EmergencyVehiclesTableConfig.columns
      })
      return createConfig
    },
    // 初始化编辑窗口配置
