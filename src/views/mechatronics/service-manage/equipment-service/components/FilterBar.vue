<template>
  <div class="filter-bar">
    ...
    <div v-if="config.actions && config.actions.length > 0" class="filter-bar__item">
      ...
      <el-button v-if="config.actions.indexOf('checkSpare') > -1" type="primary" size="medium" icon="el-icon-search" @click="checkSpare()">查看备品备件</el-button>
    </div>
