  ...
  <div class="page-container">
    <div class="filter-bar">
      ...
      <div class="filter-bar__item">
        ...
        <el-button type="primary" size="medium" @click="search()"><i class="el-icon-check el-icon--left" />生命周期信息修改</el-button>
        <el-button type="success" size="medium" plain @click="search()"><i class="el-icon-download el-icon--left" />打包下载二维码</el-button>
        <el-button type="primary" size="medium" plain @click="search()"><i class="el-icon-edit-outline el-icon--left" />基本信息修改</el-button>
      </div>
    </div>
    <el-table
      :data="tableData"
