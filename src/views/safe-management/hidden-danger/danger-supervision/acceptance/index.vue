<template>
  <div class="page-container">
    ...
    >
      ...
      <el-table-column prop="measure" align="center" label="整改意见" />

      <el-table-column prop="statusExplain" align="center" label="状态说明" />
      <el-table-column prop="person" align="center" label="整改人员" />
      <el-table-column prop="measure" align="center" label="整改措施" />
      <el-table-column prop="completeDate" align="center" label="完成时间" />
      <el-table-column prop="capital" align="center" label="所需资金" />
      <el-table-column prop="changeExplain" align="center" label="整改说明" />
