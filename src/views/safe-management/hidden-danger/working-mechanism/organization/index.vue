  ...
  export default {
    ...
    methods: {
      ...
      asyncData(tree, treeNode, resolve) {
        ...
        getHiddenTissueChildTree(tree.aqglHiddenTissueId).then(response => {
      ...
      createSubmit(submitData) {
        ...
        saveAqglHiddenTissue(submitData).then(response => {
          this.__fetchData()
      ...
      editSubmit(submitData) {
        ...
        updateaqglHiddenTissue(submitData).then(response => {
          this.__fetchData()
