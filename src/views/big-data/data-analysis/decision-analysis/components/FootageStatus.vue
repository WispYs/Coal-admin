<template>
  <div class="footage-status">
    <div class="item-title">
      <p>进尺状态</p>
      <el-select v-model="time" placeholder="请选择" class="title-select" popper-class="decision__select">
        <el-option
